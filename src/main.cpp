...
int main(int argc, char *argv[])
{
    ...
    qRegisterMetaType<JourneyResultItem>();
    qRegisterMetaType<JourneyResultHeader>();
        ...
        qmlRegisterUncreatableType<JourneyResults>("Fahrplan", 1, 0, "JourneyResults"
