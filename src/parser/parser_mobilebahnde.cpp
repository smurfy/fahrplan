...
QString ParserMobileBahnDe::getTrainRestrictionsCodes(int trainrestrictions)
{
 ...
 void ParserMobileBahnDe::searchJourney(const QString &departureStation, const QString &arrivalStation, const QString &viaStation, const QDate &date, const QTime &time, Mode mode, int trainrestrictions)
 {
