...
Page {
    ...
    Flickable {
        ...
        Text {
            id: moreText
            text: "This or prior versions uses code contribution by:<br><i>gri</i>, <i>lorenzph</i>, <i>CaCO3</i>, <i>hcm</i>, <i>thp</i>, <i>qwerty12</i>, <i>qbast</i>, <i>Thomas Fischer</i>, <i>leppa</li>, <i>NightShift79</i>" +
                  "<br><br>" +
